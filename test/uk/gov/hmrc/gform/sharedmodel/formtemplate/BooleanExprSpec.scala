...
class BooleanExprSpec extends Spec {
  ...
  "Fred greater than Dave" should "return true" in new TestFred {
    BooleanExpr.isTrue(GreaterThan(FormCtx("firstName"), Constant("Dave")), rawDataFromBrowser, authContext) shouldBe true
  }

  "Dave greater than Fred" should "return false" in new Test {
    override val value = "Dave"
    BooleanExpr.isTrue(GreaterThan(FormCtx("firstName"), Constant("Fred")), rawDataFromBrowser, authContext) shouldBe false
  }
  ...
  "1 greater than or equal to 0" should "return true" in new Test {
    override val value = "1"
    BooleanExpr.isTrue(GreaterThanOrEquals(FormCtx("number"), Constant("0")), rawDataFromBrowser, authContext) shouldBe true
  }

  "0 greater than or equal to -1" should "return true" in new TestZero {
    BooleanExpr.isTrue(GreaterThanOrEquals(FormCtx("number"), Constant("-1")), rawDataFromBrowser, authContext) shouldBe true
  }

  "0 greater than or equal to 1" should "return false" in new TestZero {
    BooleanExpr.isTrue(GreaterThanOrEquals(FormCtx("number"), Constant("1")), rawDataFromBrowser, authContext) shouldBe false
  }
  ...
  "Fred greater than or equal to Dave" should "return true" in new TestFred {
    BooleanExpr.isTrue(GreaterThanOrEquals(FormCtx("firstName"), Constant("Dave")), rawDataFromBrowser, authContext) shouldBe true
  }

  "Dave greater than or equal to Fred" should "return false" in new Test {
    override val value = "Dave"
    BooleanExpr.isTrue(GreaterThanOrEquals(FormCtx("firstName"), Constant("Fred")), rawDataFromBrowser, authContext) shouldBe false
  }

  "Fred greater than or equal to Fred" should "return true" in new TestFred {
    BooleanExpr.isTrue(GreaterThanOrEquals(FormCtx("firstName"), Constant("Fred")), rawDataFromBrowser, authContext) shouldBe true
  }
  ...
  "1 less than or equal to 0" should "return false" in new Test {
    override val value = "1"
    BooleanExpr.isTrue(LessThanOrEquals(FormCtx("number"), Constant("0")), rawDataFromBrowser, authContext) shouldBe false
  }

  "0 less than or equal to -1" should "return false" in new TestZero {
    BooleanExpr.isTrue(LessThanOrEquals(FormCtx("number"), Constant("-1")), rawDataFromBrowser, authContext) shouldBe false
  }

  "0 less than or equal to 1" should "return true" in new TestZero {
    BooleanExpr.isTrue(LessThanOrEquals(FormCtx("number"), Constant("1")), rawDataFromBrowser, authContext) shouldBe true
  }

  "0 less than or equal to 0" should "return true" in new TestZero {
    BooleanExpr.isTrue(LessThanOrEquals(FormCtx("number"), Constant("0")), rawDataFromBrowser, authContext) shouldBe true
  }

  "Fred less than or equal to Dave" should "return false" in new Test {
    override val value = "Fred"
    BooleanExpr.isTrue(LessThanOrEquals(FormCtx("firstName"), Constant("Dave")), rawDataFromBrowser, authContext) shouldBe false
  }

  "Dave less than or equal to Fred" should "return true" in new Test {
    override val value = "Dave"
    BooleanExpr.isTrue(LessThanOrEquals(FormCtx("firstName"), Constant("Fred")), rawDataFromBrowser, authContext) shouldBe true
  }
